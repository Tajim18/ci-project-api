                        ...
                        <div class="bg-secondary rounded h-100 p-4">
							...
							<div class="row">
								...
								<div class="mb-3 col-xl-6">
                                    ...
                                    <input onkeyup="getUrl(this.value)" name="name" type="text" class="form-control" id="exampleInputPassword1">
                                </div>
								
								<div class="mb-3 col-xl-6">
                                    <label for="exampleInputPassword1" class="form-label">URL</label>
                                    <input id="urlkey" type="text" name="url" class="form-control" id="exampleInputPassword1">
                                </div>
